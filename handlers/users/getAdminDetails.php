...
try {
    ...
    if (! $result['status'] || $result['data']['role'] !== ROLE_ADMIN) {
        echo json_encode(Result::fail('Admin not found'));
        exit;
    }

    echo json_encode(Result::success('Admin details fetched', $result['data']));
